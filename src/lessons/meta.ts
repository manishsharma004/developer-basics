...
export const lessonsMeta: LessonMeta[] = [
  ...
  {
    id: 'js-fundamentals',
    path: '/lessons/js-fundamentals',
    title: 'JavaScript Fundamentals',
    tagline: 'Event loop, promises, DOM, and ES modules before React.',
    icon: '🟨',
    level: 'Beginner',
    minutes: 18,
    summary:
      'Learn JS values, closures, promises, the event loop, and DOM basics with an interactive queue simulator.',
    group: 'web',
    sections: [
      { id: 'intro', title: 'Why it matters' },
      { id: 'model', title: 'Core concepts' },
      { id: 'playground', title: 'Watch the event loop' },
  ...
  {
    id: 'http-clients',
    path: '/lessons/http-clients',
    title: 'HTTP Clients',
    tagline: 'fetch, status codes, timeouts, and retries.',
    icon: '📡',
    level: 'Beginner',
    minutes: 15,
    summary:
      'Call APIs with fetch, handle 4xx/5xx, simulate retries with backoff, and understand timeouts.',
    group: 'web',
    sections: [
      { id: 'intro', title: 'Why it matters' },
      { id: 'model', title: 'Client essentials' },
      { id: 'playground', title: 'Simulate fetch' },
      ...CLOSING,
    ],
  },
  {
    id: 'browser-rendering',
    path: '/lessons/browser-rendering',
    title: 'How Browsers Render Pages',
    tagline: 'DOM, CSSOM, layout, paint, and composite.',
    icon: '🎨',
    level: 'Intermediate',
    minutes: 16,
    summary:
      'Walk the rendering pipeline and see which CSS changes trigger layout vs paint.',
    group: 'web',
    sections: [
      { id: 'intro', title: 'Why it matters' },
      { id: 'model', title: 'The pipeline' },
      { id: 'playground', title: 'Invalidate stages' },
      ...CLOSING,
    ],
  },
  {
  ...
  {
    id: 'git-advanced',
    path: '/lessons/git-advanced',
    title: 'Git: Conflicts, Rebase & PRs',
    tagline: 'Merge conflicts, rebase workflow, and pull requests.',
    icon: '🔀',
    level: 'Intermediate',
    minutes: 18,
    summary:
      'Resolve conflict markers, compare merge vs rebase, and follow the PR review workflow.',
    group: 'tooling',
    sections: [
      { id: 'intro', title: 'Why it matters' },
      { id: 'conflicts', title: 'Merge conflicts' },
      { id: 'rebase', title: 'Rebase vs merge' },
      { id: 'pr', title: 'Pull request workflow' },
      ...CLOSING,
    ],
  },
  {
    ...
    title: 'Package Managers & Semver',
    tagline: 'npm, pip, bun, lockfiles, and version ranges.',
    icon: '📦',
    level: 'Beginner',
    minutes: 14,
    summary:
      'Understand semver ranges, lockfiles, and transitive dependencies with an interactive checker.',
    group: 'tooling',
    sections: [
      { id: 'intro', title: 'Why it matters' },
      { id: 'model', title: 'How installs work' },
      { id: 'playground', title: 'Try semver ranges' },
      ...CLOSING,
    ],
  },
  {
    id: 'env-config',
    path: '/lessons/env-config',
    title: 'Environment Variables & Config',
    tagline: '.env files, precedence, and keeping secrets safe.',
    icon: '🔧',
    level: 'Beginner',
    minutes: 14,
    summary:
      'Learn config precedence, 12-factor env vars, and why you must not commit or log secrets.',
    group: 'tooling',
    sections: [
      { id: 'intro', title: 'Why it matters' },
      { id: 'model', title: 'The config model' },
      { id: 'playground', title: 'Resolve config' },
      ...CLOSING,
    ],
  },
  {
  ...
  {
    id: 'capstone',
    path: '/lessons/capstone',
    title: 'Capstone: Task Tracker',
    tagline: 'Stitch SQL, API, React, auth, tests, and deploy into one path.',
    icon: '🏁',
    level: 'Intermediate',
    minutes: 20,
    summary:
      'Follow a guided capstone checklist across existing lessons to build a task tracker end-to-end.',
    group: 'design',
    sections: [
      { id: 'intro', title: 'Why it matters' },
      { id: 'model', title: 'The project' },
      { id: 'playground', title: 'Your checklist' },
      ...CLOSING,
    ],
  },
]
